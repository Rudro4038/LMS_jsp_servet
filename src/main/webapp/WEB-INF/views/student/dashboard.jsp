...
<div class="container mt-5">
    ...
    <div class="dashboard-header">
        ...
        <p class="mb-0">Welcome, <%= user.getUsername() %>! Manage your courses and learning here.</p>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <p style="margin-top: 10px; font-size: 12px; color: #999;">View and manage enrolled courses</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <p style="margin-top: 10px; font-size: 12px; color: #999;">Track your learning progress</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <p style="margin-top: 10px; font-size: 12px; color: #999;">View your academic performance</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-4">
            <div class="feature-card">
                ...
                <a href="${pageContext.request.contextPath}/student/courses" class="btn-feature">Browse Courses</a>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="feature-card">
                ...
                <a href="${pageContext.request.contextPath}/student/courses?view=enrolled" class="btn-feature">My Courses</a>
            </div>
        </div>
    ...
    <div class="quick-actions">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-3">
                <a href="${pageContext.request.contextPath}/student/courses" class="btn btn-primary btn-block">
                    🔍 Browse Courses
                </a>
            </div>
            <div class="col-md-6 col-lg-3 mb-3">
                <a href="${pageContext.request.contextPath}/student/courses?view=enrolled" class="btn btn-info btn-block">
                    ✅ My Courses
                </a>
            </div>
            <div class="col-md-6 col-lg-3 mb-3">
