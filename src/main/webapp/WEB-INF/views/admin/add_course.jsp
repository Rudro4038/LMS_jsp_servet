            ...
            <form action="${pageContext.request.contextPath}/admin/courses" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="courseName" name="courseName" 
                           placeholder="e.g., Web Development 101" required maxlength="255">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="teacherId" name="teacherId" 
                           placeholder="Enter Teacher ID" required min="1">
                ...
                <div class="form-group">
                    <label for="capacity"><strong>Course Capacity (Max Students) *</strong></label>
                    <input type="number" class="form-control" id="capacity" name="capacity" 
                           placeholder="e.g., 30" required min="1" max="500" value="30">
                    <small class="form-text text-muted">
                ...
                <div class="btn-group-custom">
                    <button type="submit" class="btn btn-primary flex-grow-1">Add Course</button>
                    <a href="${pageContext.request.contextPath}/admin/courses?action=view" 
                       class="btn btn-secondary flex-grow-1">View All Courses</a>
                </div>
            </form>
        </div>
    </div>
